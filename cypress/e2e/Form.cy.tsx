...
describe("component - Form", () => {
  describe("Control", () => {
        ...
        cy.get("#control-form-1").within(() => {
          cy.get('div[id="control-form-1-first-name-input"]').within(() => {
            ...
            cy.get('input[id="control-form-1-first-name"]')
              ...
              .then(($value) => {
                ...
                cy.get("div")
                  .contains("Enter your first name")
                  .should("have.attr", "id")
                  .then(($id) => {
          ...
          cy.get('div[id="control-form-1-last-name-input"]').within(() => {
            ...
            cy.get('input[id="control-form-1-last-name"]')
              .should("not.attr", "aria-invalid", "false")
              .should("have.attr", "type", "text")
     ...
     *
     * @Description
     * Test setting default value for form component.
     *
     * @Covers
     * @form_types
     *   @control
     *
     * @form_component_features
     *   @defualt_value
     */
    describe("Test 7", () => {
      beforeEach(() => {
       ...
       * @functionality
       *
       * This test should check if the default value was set properly during load.
       *
       * @form_component_features
       *   @defualt_value
       */
      it("should successfully set default value (on load) ", () => {
        cy.get("#control-form-7").within(() => {
          cy.get('input[id="control-form-7-first-name"]').should("have.value", "john");
        });
      });
       ...
       * @functionality
       *
       * This test should ensure the default value can be changed as expected during a
       * change event.
       *
       * @form_component_features
       *   @defualt_value
       */
      it("should successfully update default value (on change) ", () => {
        cy.get("#control-form-7").within(() => {
          cy.get('input[id="control-form-7-first-name"]').should("have.value", "john");

          cy.get('input[id="control-form-7-first-name"]').clear();
          cy.get('input[id="control-form-7-first-name"]').type("jan");

          cy.get('input[id="control-form-7-first-name"]').should("have.value", "jan");
        });
      });
    });
  });

  describe("Declaritive", () => {
    /**
     * @Test_1
     *
     * @Form_type Declaritive
     *
     * @Description
     * Test component layout validating all accessibility attributes and
     * associations are correct during form load and state changes where
    ...
    describe("Test 1", () => {
       ...
       */
      it("should find accessibility attributes on load", () => {
        cy.get("#declaritive-form-1").within(() => {
          cy.get('div[id="declaritive-form-1-first-name-input"]').within(() => {
            /** First Name: <required> **/

            /** Label */
            cy.get('label[for="declaritive-form-1-first-name"]')
              .contains("First Name")
              .within(() => {
                cy.get("span")
                  .should("have.attr", "aria-hidden", "true")
          ...
          cy.get('div[id="declaritive-form-1-last-name-input"]').within(() => {
            /** Last Name: <optional> **/

            /** Label */
            cy.get('label[for="declaritive-form-1-last-name"]')
              .contains("Last Name")
              .within(() => {
                cy.get("span").should(($span) => {
                  expect($span).to.have.length(0);
            ...
            /** Input */
            cy.get('input[id="declaritive-form-1-last-name"]')
              .should("not.attr", "aria-invalid", "false")
              .should("have.attr", "type", "text")
              .should("not.attr", "required");
          ...
          cy.get('div[id="declaritive-form-1-email-input"]').within(() => {
            /** Email: <required> **/

            /** Label */
            cy.get('label[for="declaritive-form-1-email"]')
              .contains("Email")
              .within(() => {
                cy.get("span")
                  .should("have.attr", "aria-hidden", "true")
          ...
          cy.get('div[id="declaritive-form-1-password-input"]').within(() => {
            /** Password: <required> **/

            /** Label */
            cy.get('label[for="declaritive-form-1-password"]')
              .contains("Password")
              .within(() => {
                cy.get("span")
                  .should("have.attr", "aria-hidden", "true")
      ...
      it("should find accessibility attributes on update", () => {
        cy.get("#declaritive-form-1").within(() => {
          /** Click causing errors **/
          cy.get('button[id="declaritive-form-1-submit-btn"]').click();
    ...
    describe("Test 2", () => {
       ...
       */
      it("should successfully submit non-validated form ", () => {
        cy.get("#declaritive-form-2").within(() => {
          /** Submit empty form **/
          cy.get('button[id="declaritive-form-2-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="declaritive-form-2-first-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-2-last-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-2-email"]').should("have.value", "");
          cy.get('input[id="declaritive-form-2-password"]').should("have.value", "");

          /** Fill partial fields **/
          cy.get('input[id="declaritive-form-2-first-name"]').type("john");
          cy.get('input[id="declaritive-form-2-last-name"]').type("doe");
          cy.get('input[id="declaritive-form-2-email"]').type("john@foo.com");
    ...
    describe("Test 3", () => {
       ...
       */
      it("should successfully submit validated form (on change)", () => {
        cy.get("#declaritive-form-3").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="declaritive-form-3-first-name"]').type("john");
          cy.get('input[id="declaritive-form-3-first-name"]').clear().blur();

          cy.get("#declaritive-form-3-first-name-input")
            .contains("Required Declaritive 3")
            .should(($p) => {
              expect($p).to.have.length(1);
            });

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-3-submit-btn"]').click();

          /**
           * All fields should have errors.
           */
          cy.get(".declaritive-form-3-error").should(($p) => {
            expect($p).to.have.length(4);
          });

          /** Fill partial fields **/
          cy.get('input[id="declaritive-form-3-first-name"]').type("john");
          cy.get('input[id="declaritive-form-3-last-name"]').type("doe");
          cy.get('input[id="declaritive-form-3-email"]').type("john@foo.com");
          cy.get('input[id="declaritive-form-3-password"]').type("1919");

          /** Submit valid form **/
          cy.get('button[id="declaritive-form-3-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="declaritive-form-3-first-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-3-last-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-3-email"]').should("have.value", "");
          cy.get('input[id="declaritive-form-3-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 4", () => {
       ...
       */
      it("should successfully submit validated form (on submit)", () => {
        cy.get("#declaritive-form-4").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="declaritive-form-4-first-name"]').type("john");
          cy.get('input[id="declaritive-form-4-first-name"]').clear().blur();

          /**
           * Should not have any errors.
           */
          cy.get("#declaritive-form-4-first-name-input")
            .contains("Required Declaritive 4")
            .should(($p) => {
              expect($p).to.have.length(0);
            });

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-4-submit-btn"]').click();

          /**
           * All fields should have errors.
           */
          cy.get(".declaritive-form-4-error").should(($p) => {
            expect($p).to.have.length(4);
          });

          /** Fill partial fields **/
          cy.get('input[id="declaritive-form-4-first-name"]').type("john");
          cy.get('input[id="declaritive-form-4-last-name"]').type("doe");
          cy.get('input[id="declaritive-form-4-email"]').type("john@foo.com");
          cy.get('input[id="declaritive-form-4-password"]').type("1919");

          /** Submit valid form **/
          cy.get('button[id="declaritive-form-4-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="declaritive-form-4-first-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-4-last-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-4-email"]').should("have.value", "");
          cy.get('input[id="declaritive-form-4-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 5", () => {
       ...
       */
      it("should successfully submit validated form after auto focus (on change) ", () => {
        cy.get("#declaritive-form-5").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="declaritive-form-5-first-name"]').type("john");
          cy.get('input[id="declaritive-form-5-first-name"]').clear().blur();

          cy.get("#declaritive-form-5-first-name-input")
            .contains("Required Declaritive 5")
            .should(($p) => {
              expect($p).to.have.length(1);
            });

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-5-first-name");
          });
          cy.get('input[id="declaritive-form-5-first-name"]').type("john");
          ...
          cy.get('button[id="declaritive-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-5-last-name");
          });
          cy.get('input[id="declaritive-form-5-last-name"]').type("doe");

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-5-email");
          });
          cy.get('input[id="declaritive-form-5-email"]').type("john@foo.com");

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-5-password");
          });
          cy.get('input[id="declaritive-form-5-password"]').type("1919");

          /**
           * No errors are found.
           */
          cy.get(".declaritive-form-5-error").should(($p) => {
            expect($p).to.have.length(0);
          });
          ...
          /** Fields should be empty **/
          cy.get('input[id="declaritive-form-5-first-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-5-last-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-5-email"]').should("have.value", "");
          cy.get('input[id="declaritive-form-5-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 6", () => {
       ...
       */
      it("should successfully submit validated form after auto focus (on submit) ", () => {
        cy.get("#declaritive-form-6").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="declaritive-form-6-first-name"]').type("john");
          cy.get('input[id="declaritive-form-6-first-name"]').clear().blur();

          cy.get("#declaritive-form-6-first-name-input")
            .contains("Required Declaritive 6")
            .should(($p) => {
              expect($p).to.have.length(0);
            });

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-6-first-name");
          });
          cy.get('input[id="declaritive-form-6-first-name"]').type("john");
          ...
          cy.get('button[id="declaritive-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-6-last-name");
          });
          cy.get('input[id="declaritive-form-6-last-name"]').type("doe");

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-6-email");
          });
          cy.get('input[id="declaritive-form-6-email"]').type("john@foo.com");

          /** Submit partial form **/
          cy.get('button[id="declaritive-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("declaritive-form-6-password");
          });
          cy.get('input[id="declaritive-form-6-password"]').type("1919");

          /**
           * No errors are found.
           */
          cy.get(".declaritive-form-6-error").should(($p) => {
            expect($p).to.have.length(0);
          });
          ...
          /** Fields should be empty **/
          cy.get('input[id="declaritive-form-6-first-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-6-last-name"]').should("have.value", "");
          cy.get('input[id="declaritive-form-6-email"]').should("have.value", "");
          cy.get('input[id="declaritive-form-6-password"]').should("have.value", "");
        });
      });
    });
  });
