  ...
  describe("Standard", () => {
    ...
    describe("Test 2", () => {
      ...
      it("should successfully submit non-validated form ", () => {
        cy.get("#standard-form-2").within(() => {
          /** Submit empty form **/
          cy.get('button[id="standard-form-2-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="standard-form-2-first-name"]').should("have.value", "");
          cy.get('input[id="standard-form-2-last-name"]').should("have.value", "");
          cy.get('input[id="standard-form-2-email"]').should("have.value", "");
          cy.get('input[id="standard-form-2-password"]').should("have.value", "");

          /** Fill partial fields **/
          cy.get('input[id="standard-form-2-first-name"]').type("john");
          cy.get('input[id="standard-form-2-last-name"]').type("doe");
          cy.get('input[id="standard-form-2-email"]').type("john@foo.com");
    ...
    describe("Test 3", () => {
      ...
      it("should successfully submit validated form (on change)", () => {
        cy.get("#standard-form-3").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="standard-form-3-first-name"]').type("john");
          cy.get('input[id="standard-form-3-first-name"]').clear().blur();

          cy.get("#standard-form-3-first-name-input")
          ...
          /** Submit partial form **/
          cy.get('button[id="standard-form-3-submit-btn"]').click();

          /**
           * All fields should have errors.
           */
          cy.get(".standard-form-3-error").should(($p) => {
            expect($p).to.have.length(4);
          });

          /** Fill partial fields **/
          cy.get('input[id="standard-form-3-first-name"]').type("john");
          cy.get('input[id="standard-form-3-last-name"]').type("doe");
          cy.get('input[id="standard-form-3-email"]').type("john@foo.com");
          cy.get('input[id="standard-form-3-password"]').type("1919");

          /** Submit valid form **/
          cy.get('button[id="standard-form-3-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="standard-form-3-first-name"]').should("have.value", "");
          cy.get('input[id="standard-form-3-last-name"]').should("have.value", "");
          cy.get('input[id="standard-form-3-email"]').should("have.value", "");
          cy.get('input[id="standard-form-3-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 4", () => {
      ...
      it("should successfully submit validated form (on submit)", () => {
        cy.get("#standard-form-4").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="standard-form-4-first-name"]').type("john");
          cy.get('input[id="standard-form-4-first-name"]').clear().blur();

          /**
           * Should not have any errors.
           */
          cy.get("#standard-form-4-first-name-input")
            .contains("Required 4")
            .should(($p) => {
          ...
          /** Submit partial form **/
          cy.get('button[id="standard-form-4-submit-btn"]').click();

          /**
           * All fields should have errors.
           */
          cy.get(".standard-form-4-error").should(($p) => {
            expect($p).to.have.length(4);
          });

          /** Fill partial fields **/
          cy.get('input[id="standard-form-4-first-name"]').type("john");
          cy.get('input[id="standard-form-4-last-name"]').type("doe");
          cy.get('input[id="standard-form-4-email"]').type("john@foo.com");
          cy.get('input[id="standard-form-4-password"]').type("1919");

          /** Submit valid form **/
          cy.get('button[id="standard-form-4-submit-btn"]').click();

          /** Fields should be empty **/
          cy.get('input[id="standard-form-4-first-name"]').should("have.value", "");
          cy.get('input[id="standard-form-4-last-name"]').should("have.value", "");
          cy.get('input[id="standard-form-4-email"]').should("have.value", "");
          cy.get('input[id="standard-form-4-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 5", () => {
      ...
      it("should successfully submit validated form after auto focus (on change) ", () => {
        cy.get("#standard-form-5").within(() => {
          /**
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="standard-form-5-first-name"]').type("john");
          cy.get('input[id="standard-form-5-first-name"]').clear().blur();

          cy.get("#standard-form-5-first-name-input")
          ...
          /** Submit partial form **/
          cy.get('button[id="standard-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-5-first-name");
          });
          cy.get('input[id="standard-form-5-first-name"]').type("john");
          ...
          cy.get('button[id="standard-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-5-last-name");
          });
          cy.get('input[id="standard-form-5-last-name"]').type("doe");

          /** Submit partial form **/
          cy.get('button[id="standard-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-5-email");
          });
          cy.get('input[id="standard-form-5-email"]').type("john@foo.com");

          /** Submit partial form **/
          cy.get('button[id="standard-form-5-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-5-password");
          });
          cy.get('input[id="standard-form-5-password"]').type("1919");

          /**
           * No errors are found.
           */
          cy.get(".standard-form-5-error").should(($p) => {
            expect($p).to.have.length(0);
          });
          ...
          /** Fields should be empty **/
          cy.get('input[id="standard-form-5-first-name"]').should("have.value", "");
          cy.get('input[id="standard-form-5-last-name"]').should("have.value", "");
          cy.get('input[id="standard-form-5-email"]').should("have.value", "");
          cy.get('input[id="standard-form-5-password"]').should("have.value", "");
        });
      });
    });
    ...
    describe("Test 6", () => {
      ...
      it("should successfully submit validated form after auto focus (on submit) ", () => {
        cy.get("#standard-form-6").within(() => {
           ...
           * Add value, remove and blur to set the error.
           */
          cy.get('input[id="standard-form-6-first-name"]').type("john");
          cy.get('input[id="standard-form-6-first-name"]').clear().blur();

          cy.get("#standard-form-6-first-name-input")
            .contains("Required 6")
            .should(($p) => {
              expect($p).to.have.length(0);
            });
          ...
          /** Submit partial form **/
          cy.get('button[id="standard-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-6-first-name");
          });
          cy.get('input[id="standard-form-6-first-name"]').type("john");
          ...
          cy.get('button[id="standard-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-6-last-name");
          });
          cy.get('input[id="standard-form-6-last-name"]').type("doe");

          /** Submit partial form **/
          cy.get('button[id="standard-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-6-email");
          });
          cy.get('input[id="standard-form-6-email"]').type("john@foo.com");

          /** Submit partial form **/
          cy.get('button[id="standard-form-6-submit-btn"]').click();
          cy.focused().then(($el) => {
            expect($el).to.have.id("standard-form-6-password");
          });
          cy.get('input[id="standard-form-6-password"]').type("1919");

          /**
           * No errors are found.
           */
          cy.get(".standard-form-6-error").should(($p) => {
            expect($p).to.have.length(0);
          });
          ...
          /** Fields should be empty **/
          cy.get('input[id="standard-form-6-first-name"]').should("have.value", "");
          cy.get('input[id="standard-form-6-last-name"]').should("have.value", "");
          cy.get('input[id="standard-form-6-email"]').should("have.value", "");
          cy.get('input[id="standard-form-6-password"]').should("have.value", "");
        });
      });
    });
  });
